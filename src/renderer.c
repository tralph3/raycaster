...
void draw_world(Renderer *renderer, Player *player, Map *map) {
    ...
    thread_pool_wait_all_tasks(&pool);
...
void draw_everything(Renderer *r, Player *p, Map *m) {
    renderer = r;
    player = p;
    map = m;
...
void init_renderer(Renderer *renderer) {
    ...
    thread_pool_create(&pool, render_thread_count, draw_stripe);
